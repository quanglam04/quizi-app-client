...
export default function BlogPostPage() {
  ...
  if (error || !post) {
    return (
      <div className="text-center py-20">
        <h2 className="text-3xl font-black text-white mb-2">404 - Không tìm thấy bài viết</h2>
        <p className="text-white/40">Bài viết bạn đang tìm kiếm không tồn tại hoặc đã bị gỡ bỏ.</p>
        <Link to="/blog" className="mt-8 inline-flex items-center gap-2 text-sky-400 font-bold hover:text-sky-300 transition-colors">
  ...
  return (
    <article className="max-w-3xl mx-auto py-12 px-4 sm:px-0 pb-32">
      <Link to="/blog" className="inline-flex items-center gap-2 text-sm font-bold text-white/40 hover:text-sky-400 mb-12 transition-all">
